...
<section class="container py-lg-5">
  <!--User table-->
    <h1>Here are the Students daily logs</h1>
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint" style="color:#ffffff;"><b>Filter By Fingerprint ID:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device" style="color:#ffffff;"><b>Filter By department:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint" style="color:#ffffff;"><b>Export to Excel:</b></label>
