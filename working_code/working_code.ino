...
const char *ssid = "PLERY-68FB";
const char *password = "200219600581";
const char* device_token  = "99af6197";
//************************************************************************
String getData, Link;
String URL = "http://192.168.0.198/biometricattendace/getdata.php"; //computer IP or the server domain
//************************************************************************
...
void loop() {
  ...
  if(!WiFi.isConnected()){
    if (millis() - previousMillis >= 10000) {
      ...
      void connectToWiFi();    //Retry to connect to Wi-Fi
    }
  }
...
uint8_t deleteFingerprint(int id) {
  uint8_t p = -1; // Initialize with an error value
  ...
  return p; // Ensure a return value
}  
